...
export const EditAddressModal = () => {
  ...
  const fillDummyAddressForm = (e) => {
    e.preventDefault();
    const form = editAddressModal.current;
    form["fullName"].value = "Abhijeet Gorde";
    form["flatName"].value = " Sangharsh Nivas";
    form["area"].value = "gavthan";
    form["landmark"].value = "Gorde wasti";
    form["city"].value = "Lonimavala";
    form["pincode"].value = "414307";
    form["stateSelect"].value = "Maharashtra";
    form["contact"].value = "8767913257";
  };
  return (
