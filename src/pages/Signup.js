...
export const Signup = () => {
  ...
  const fillDummyData = (e) => {
    e.preventDefault();
    const form = editSignupForm.current;
    form["firstName"].value = "Abhijeet";
    form["lastName"].value = "Gorde";
    form["emailId"].value = "testuser@gmail.com";
    form["passwordField"].value = "23122005";
    form["confirmPasswordField"].value = "23122005";
  };
